...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyls-black-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10337&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyls-black-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyls-black` can be installed with:

```
conda install pyls-black
```

It is possible to list all of the versions of `pyls-black` available on your platform with:
